# == Class: holland::augeas
#
# There isn't an {Augeas}[http://augeas.net/] lens for +holland.conf+ in the upstream project yet so we'll need to provide one
# ourselves. Since Puppet requires +augeas-libs+ we don't need to manage the parrent directories since they'll already be in place.
#
# === Parameters
#
# None
